...
func TestPureLTRIsIdentity(t *testing.T) {
	if l := Order([]rune("hello world"), false, nil); l != nil {
...
func TestMarkedLayout(t *testing.T) {
	...
	if OrderMarked([]rune("plain text"), false, nil) != nil {
