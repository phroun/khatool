...
func TestPrecomposeCluster(t *testing.T) {
	...
	cases := []struct {
		...
		{"bare shin dot", []rune{MarkAnchor, shinDot}, str(0xFB2A), true},
		{"bare sin dot", []rune{MarkAnchor, sinDot}, str(0xFB2B), true},
		{"bare holam-haser", []rune{MarkAnchor, holamHaser}, str(0xFB4B), true},
		{"bare vowel stays on its circle", []rune{MarkAnchor, sheva}, "", false},
